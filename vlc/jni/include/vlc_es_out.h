...
//    es_out_id_t   *es = malloc( sizeof( struct es_out_id_t ) );
//    return es;
...
//{
//    msg_Dbg(p_demux, "can track es_out del");
//     out->pf_del( out, id );
//}
...
//{
//
//    msg_Dbg(p_demux, "can track es_out send");
//    return VLC_SUCCESS;
...
{
   msg_Dbg(p_demux, "can track es_out vaControl:%d",i_query);
